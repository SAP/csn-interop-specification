...
export interface StructuredElementReference {
  /**
   * Reference to external target with *association name* and *target element name* in `target` entity (2 array items)
   * Reference to local *source element name* (1 array item).
   *
   * MUST NOT:
